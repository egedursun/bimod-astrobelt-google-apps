...
// ####################################################################################################
const GLOBAL_SERVER_URL = 'https://8dba-200-105-82-86.ngrok-free.app';
// ####################################################################################################
// ####################################################################################################
...
// ####################################################################################################
const APPLICATION_NAME = 'Bimod Astrobelt Drafting';
...
const MENU_ITEM_NAME_SET_AUTHENTICATION_KEY = 'Set BimodLab Drafting Authentication Key';
const MENU_CONTENT_INSTRUCTION_SET_AUTHENTICATION_KEY = 'Please enter your Bimod.io Drafting Authentication Key:';
...
const APPLICATION_PROCESS_ERROR_NO_AUTHENTICATION_KEY = 'Authentication key is missing. Please set it from the Bimod Astrobelt Drafting menu.';
...
const COMMAND_ENDPOINT__AI = '/app/drafting/public/generate/commands/ai/';
const COMMAND_ENDPOINT__AUTO = '/app/drafting/public/generate/commands/auto/';
const COMMAND_ENDPOINT__SELECT = '/app/drafting/public/generate/commands/select/';
const COMMAND_ENDPOINT__WEB = '/app/drafting/public/generate/commands/web/';
const COMMAND_ENDPOINT__IMG = '/app/drafting/public/generate/commands/img/';
const COMMAND_ENDPOINT__SQL = '/app/drafting/public/generate/commands/sql/';
const COMMAND_ENDPOINT__NOSQL = '/app/drafting/public/generate/commands/nosql/';
const COMMAND_ENDPOINT__SSH = '/app/drafting/public/generate/commands/ssh/';
const COMMAND_ENDPOINT__VECT = '/app/drafting/public/generate/commands/vect/';
const COMMAND_ENDPOINT__REPO = '/app/drafting/public/generate/commands/repo/';
const COMMAND_ENDPOINT__SITE = '/app/drafting/public/generate/commands/site/';
